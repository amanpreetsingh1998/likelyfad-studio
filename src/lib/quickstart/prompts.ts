...
export function buildQuickstartPrompt(
  ...
  return `You are a workflow designer for Likelyfad Studio, a visual node-based AI image generation tool. Your task is to create a workflow JSON based on the user's description.
...
export function buildSimplePrompt(description: string): string {
  return `Create a Likelyfad Studio workflow JSON for: "${description}"
